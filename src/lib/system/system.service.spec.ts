...
describe('System Service:', () => {
  ...
  it('expect to do a query succesfully',
    async(inject([VantageSystemService, HttpTestingController],
                  (service: VantageSystemService, httpTestingController: HttpTestingController) => {
      let success: boolean = false;
      let complete: boolean = false;
      service.query().subscribe((resp: {data: ISystem[], total: number}) => {
  ...
  it('expect to do a query failure',
    async(inject([VantageSystemService, HttpTestingController],
                  (service: VantageSystemService, httpTestingController: HttpTestingController) => {
      service.query().subscribe((data: {data: ISystem[], total: number}) => {
  ...
  it('expect to do a query with HttpParams parameters succesfully',
    async(inject([VantageSystemService, HttpTestingController],
      ...
      service.query(queryParams).subscribe((resp: {data: ISystem[], total: number}) => {
        expect(resp.data.length).toBe(0);
        expect(resp.total).toBe(0);
        success = true;
      }, () => {
  ...
  it('expect to do a query with object parameters succesfully',
    async(inject([VantageSystemService, HttpTestingController],
      ...
      service.query(<any>{
        ...
        secondParam: 2,
        thirdParam: false,
      }).subscribe((resp: {data: ISystem[], total: number}) => {
        expect(resp.data.length).toBe(0);
        expect(resp.total).toBe(0);
        success = true;
      }, () => {
  ...
  it('expect to do a get succesfully',
    async(inject([VantageSystemService, HttpTestingController],
      ...
      let success: boolean = false;
      let complete: boolean = false;
      service.get('id-of-something').subscribe((data: ISystem) => {
  ...
  it('expect to do a create succesfully',
    async(inject([VantageSystemService, HttpTestingController],
      ...
      let complete: boolean = false;
      let body: any = {};
      service.create(body).subscribe((data: ISystem) => {
        expect(data).toBeTruthy();
        success = true;
      }, () => {
        fail('on error executed when it shouldnt have with observables');
  ...
  it('expect to do an update succesfully',
    async(inject([VantageSystemService, HttpTestingController],
      ...
      let complete: boolean = false;
      let body: any = {};
      service.update('id-of-something', body).subscribe((data: ISystem) => {
        expect(data).toBeTruthy();
        success = true;
      }, () => {
        fail('on error executed when it shouldnt have with observables');
